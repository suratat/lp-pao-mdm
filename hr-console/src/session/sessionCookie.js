...
const COOKIE_NAME = 'hr_console_session';
...
// session ของ HR Console เก็บ access/refresh token ของผู้ใช้จริง (bearer credential) จึงเข้ารหัสด้วย
// JWE (dir + A256GCM) ไม่ใช่แค่เซ็นด้วย JWS เหมือน portal_session ของ Portal เดิม (ซึ่งเก็บแค่ personId
// ที่ไม่ sensitive เท่ากัน)
