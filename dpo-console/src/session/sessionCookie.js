...
// (ดูเหตุผลใน sessionStore.js) ชื่อใหม่แยกจาก dpo_console_session (JWE เดิมที่เก็บ token ทั้งชุด) เพื่อไม่ให้สับสนกับ
// cookie รุ่นเก่าที่ยังค้างในเบราว์เซอร์ - รุ่นเก่าถูกล้างทิ้งตอน login/logout
const COOKIE_NAME = 'dpo_console_sid';
const LEGACY_COOKIE_NAME = 'dpo_console_session';
